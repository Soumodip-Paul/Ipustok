        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <form className="flex mx-auto border-2 border-indigo-500 rounded overflow-hidden mt-6" onChange={ e => setPlans(e.target.value === "true") } >
                        <input className='hidden' type={'hidden'} />
                        <input className='hidden' name='plans' type="radio" id="monthly" value={true} />
                        <label htmlFor='monthly' className={`py-1 px-4 focus:outline-none ${ plans? "bg-indigo-500 text-white" : "" } `}>Monthly</label>
                        <input className='hidden' name='plans' type="radio" id="yearly" value={false} />
                        <label htmlFor='yearly' className={`py-1 px-4 ${ !plans ? "bg-indigo-500 text-white" : "" } focus:outline-none`}>Annually</label>
                    </form>
                </div>
